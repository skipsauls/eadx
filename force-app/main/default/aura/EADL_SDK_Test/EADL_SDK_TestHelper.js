({
    columns: [
        {label: 'Country', fieldName: 'name', type: 'text'},
        {label: 'Region', fieldName: 'region', type: 'text'},
        {label: 'Sub-Region', fieldName: 'sub-region', type: 'text'},
        {label: 'Intermediate-Region', fieldName: 'intermediate-region', type: 'text'},
    ],
                
	filterMap: {
        'CONTINENT_NAME': 'region',
        'COUNTRY_SHORT_NAME': 'name',
        'COUNTRY_ALPHA_3_CODE': 'name',
        'PROVINCE_STATE_NAME': null,
        'COUNTY_NAME': null,
	},
        
	filterData: function(component, key, value) {
        let self = this;
        console.warn('filterData: ', key, value);
        let filter = self.filterMap[key];
	    console.warn('filter: ', filter);
	    if (filter !== null && typeof filter !== 'undefined') {
            let data = [];
            self.countries.forEach(function(country) {
                if (filter) {
                    if (country[filter] === value) {
                        data.push(country);
                    }
                } else {
                    data.push(country);
